...
import fr.diginamic.services.exemples.entite.VehiculeExemple;
...
public class Exemple6Service extends MenuService {
	...
	public void traitement() {
		...
		vehicules.add(new VehiculeExemple(1L, "AA-552-CD", "Peugeot", "208"));
		vehicules.add(new VehiculeExemple(2L, "AW-227-XE", "Peugeot", "3008"));
		vehicules.add(new VehiculeExemple(3L, "XX-131-XT", "Peugeot", "3008"));
